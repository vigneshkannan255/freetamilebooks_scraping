...
for url in urls:
	...
	#print(category)
	books.append({'title':title,'bookid':bookid,'author':author,'image':imgsrc,'epub':epub,'category':category})
	print({'title':title,'bookid':bookid,'author':author,'image':imgsrc,'epub':epub,'category':category})
